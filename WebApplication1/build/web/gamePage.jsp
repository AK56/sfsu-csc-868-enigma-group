...
<!DOCTYPE html>
    ...
    <!--would like to have the canvas at center-->
                    ...
                    $("#dice").click(function(){
                        ...
                        .fail(function() { // on failure of the GET request
                            ...
                            alert("You are in Jail. Pay fine to get Out and Play");
                                ...
                                else if(returnSpaceId() === 4 || returnSpaceId() === 38){
                                ...
                                else if(returnSpaceId() !== 2 || returnSpaceId() !== 7 || returnSpaceId() !== 17
                                        || returnSpaceId() !== 22 || returnSpaceId() !== 33 || returnSpaceId() !== 36){
                                    if(confirm("You landed on Property: \nWould you like to buy") === true){
                                       
                                        $.get('Game.GameServlet',
                                                            {"param":"buyProperty","spaceId":returnSpaceId().toString()}, function(resp){

                                            alert("You just bought a property from Bank. CONGRATS!");
      ...
      <div id = "myConsole" style="height:300px;width:300px;border:1px solid #ccc;font:12px;overflow:auto">mjinui</div>
            </td> 
          </tr>
      </table>
        </div>
