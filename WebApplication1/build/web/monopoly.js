...
/*global variables and can be accessed anywhere in the script*/
                  ...
                  context.rect(prevCenterX, prevCenterY, length, height);
                ...
                function actionSpace(){
                    /*perform Income Tax and Luxury tax*/
                    /*else if(spaceId === 4 || spaceId === 38){
                        /*perform AJAX call to update Player's account balance*
                        $.get('Game.GameServlet', {"subtractBalance": 50},function(resp){
                            
                        });
                    }*/
                     if(spaceId === 30){
                        /*means Player has landed on GoToJail Corner, now we should move the player to Jail Space
                         * and restricts his ability to play the game unless Player pays $50 to get out of Jail space.
                         * The GoToJail corner is 20 spaces away from Jail Space, so we call movePlayer function to move
                         * player's token to 20 spaces, which is Jail Space */
                        moveToJail();
                    }
                    
                }
                function setBuyProperty(value){
                    buyProperty = value;
                }
                function returnBuyProperty(){
                    return buyProperty;
                }
