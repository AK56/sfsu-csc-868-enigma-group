...
public class Register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ifRegistered = new String("http://localhost:8080/gill/registrationSucess.html");
       ...
       //         || firstName != null || lastName != null)){
        if (UserPlayerDatabaseController.getInstance().registerNewUser(firstName, lastName,userName, passwrd))
        {
