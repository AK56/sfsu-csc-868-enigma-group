...
<%@ page language="java" import="java.lang.*" import = "User.Player" import="Database.UserPlayerDatabaseController"%>
<body>
        <%
            int playerID = (int) session.getAttribute("playerID");
            Player player = Database.UserPlayerDatabaseController.getInstance().getPlayerByID(playerID);
                    ...
                    <table width="250" border="1" align = "right">
                        ...
                        <tr>
                            <td>
                                ...
                                <p align="left"><%=firstname%> <%=lastname%></p>
                                <p align="left"> playerID <%=player.getPlayerID()%></p>
                                <p align="left">GameID: 1</p>
