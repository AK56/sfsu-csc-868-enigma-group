...
CREATE TABLE `railroad_game_data` (
  ...
  CONSTRAINT `railroad_game_data_ibfk_2` FOREIGN KEY (`bank_owner_id`) REFERENCES `bank` (`bank_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `realestate_game_data` (
  ...
  CONSTRAINT `realestate_game_data_ibfk_3` FOREIGN KEY (`bank_owner_id`) REFERENCES `bank` (`bank_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `utility_game_data` (
  ...
  CONSTRAINT `utility_game_data_ibfk_2` FOREIGN KEY (`bank_owener_id`) REFERENCES `bank` (`bank_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-05-13 17:24:42
